(ns carbonite.api
  ...
  (:import [com.esotericsoftware.kryo Kryo Serializer]
           [com.esotericsoftware.kryo.util DefaultClassResolver MapReferenceResolver]
           [java.nio ByteBuffer]))
...
(defn new-registry
  ...
  []
  (let [reference-resolver (proxy [MapReferenceResolver] []
                             (useReferences [class] true))]
    ;; This custom reference resolver seems to be required to correctly
    ;;   round-trip maps.
    (doto (Kryo. (DefaultClassResolver.) reference-resolver)
